...
class HoldsControllerTest < ActionController::TestCase
  ...
  test "should create hold" do
    assert_difference('Hold.count') do
      post :create, hold: { is_redeemed: @hold.is_redeemed, redeem_date: @hold.redeem_date, timestamp: @hold.timestamp }
    end
  ...
  test "should update hold" do
    patch :update, id: @hold, hold: { is_redeemed: @hold.is_redeemed, redeem_date: @hold.redeem_date, timestamp: @hold.timestamp }
    assert_redirected_to hold_path(assigns(:hold))
  end
